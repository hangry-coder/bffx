module bffx/examples/pipelines-calorie
...
require (
	...
	github.com/launchdarkly/go-server-sdk/v7 v7.10.1 // indirect
	...
	github.com/thomaspoignant/go-feature-flag v1.53.0 // indirect
...
replace github.com/hangry-coder/bffx => ../..
